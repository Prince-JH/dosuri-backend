# Generated by Django 4.1.2 on 2023-06-05 12:58
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('dosuri', '0083_hospitalreservation'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='user_personal_information_agreement', to=settings.AUTH_USER_MODEL)),
            ],
        ),
    ]
